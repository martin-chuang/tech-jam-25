...
def stream_thoughts():
    ...
    while retries <= max_retries:
        try:
            response = requests.get('http://localhost:5000/api/stream-thoughts', stream=True)
...
import requests
import time
from backend.src.common.utils.retry_utils import retry #this "retry" might need to be adjusted based on actual imported 
